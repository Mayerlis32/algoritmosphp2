...
<html>
  ...
  <body>
    ...
    <div class="container">
      <h4>Numero Ingresado: <?php $numero = "10"; echo $numero; ?></h4>
      <h4>Numero Ingresado: <?php $numero1 = "9"; echo $numero1; ?></h4>
      <h4>Numero Ingresado: <?php $numero2 = "8"; echo $numero2; ?></h4>

      <?php

      if ($numero < $numero1 and $numero1 < $numero2)  {echo "<h1>$numero, $numero1, $numero2</h1>";}
